...
Shader "TidalFlask/Fire URP U6-1"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float screenDepth167 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ScreenPosNorm.xy ),_ZBufferParams);
				float distanceDepth167 = abs( ( screenDepth167 - LinearEyeDepth( ScreenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
				float2 uv_ShapeMask40 = input.ase_texcoord.xy;
				float4 tex2DNode40 = tex2D( _ShapeMask, uv_ShapeMask40 );
				float4 appendResult190 = (float4(0.0 , _Noise3Speed , 0.0 , 0.0));
				float2 texCoord10 = input.ase_texcoord.xy * float2( 1.5,1 ) + float2( 0,0 );
				float2 panner192 = ( 1.0 * _Time.y * appendResult190.xy + ( texCoord10 * _Noise3Scale ));
				float clampResult195 = clamp( tex2D( _NoisePrimary, panner192 ).r , _Noise3ClampAmount , 1.0 );
				float4 appendResult14 = (float4(0.0 , _Noise1Speed , 0.0 , 0.0));
				float2 panner13 = ( 1.0 * _Time.y * appendResult14.xy + ( _Noise1Scale * texCoord10 ));
				...
				float3 temp_cast_4 = (_FlameInnerStep).xxx;
				float3 temp_cast_6 = (_FlameOuterStep).xxx;
				float2 texCoord67 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult68 = smoothstep( 0.0 , _OuterColorTopBlend , texCoord67.y);
				float4 temp_output_134_0 = ( saturate( distanceDepth167 ) * saturate( ( float4( saturate( ( ( 1.0 - _ShadingAmount ) + temp_output_41_0 ) ) , 0.0 ) * ( ( _InnerColor * float4( step( temp_cast_4 , temp_output_41_0 ) , 0.0 ) ) + ( float4( step( temp_cast_6 , temp_output_41_0 ) , 0.0 ) * ( ( _OuterColor * ( 1.0 - smoothstepResult68 ) ) + ( smoothstepResult68 * _OuterColorTop ) ) ) ) * _FlameStrength ) ) );
...
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;26;-1232,768;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;193;-1232,1120;Inherit;True;Property;_TextureSample2;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;False;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;203;4304,464;Float;False;True;-1;3;;0;13;TidalFlask/Fire URP U6-1;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;9;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;30;Surface;1;638847120021309829;  Keep Alpha;0;0;  Blend;0;0;Two Sided;1;0;Alpha Clipping;1;638847119818808577;  Use Shadow Threshold;0;0;Forward Only;0;0;Cast Shadows;0;638847119931094842;Receive Shadows;0;638847119945808928;Receive SSAO;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;  XR Motion Vectors;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position;1;0;0;13;False;True;False;True;False;False;True;True;True;False;True;False;True;False;;False;0
...
ASEEND*/
//CHKSM=040B9954F823B0D705D3604095E2799CE1E8C6CB